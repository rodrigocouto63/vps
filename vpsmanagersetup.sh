...
if [ -d "/etc/squid3/" ]
then
	wget https://github.com/rodrigocouto63/vps/squid1.txt -O /tmp/sqd1
	echo "acl url3 dstdomain -i $ipdovps" > /tmp/sqd2
	wget https://github.com/rodrigocouto63/vps/squid2.txt -O /tmp/sqd3
	cat /tmp/sqd1 /tmp/sqd2 /tmp/sqd3 > /etc/squid3/squid.conf
	wget https://github.com/rodrigocouto63/vps/payload.txt -O /etc/squid3/payload.txt
	...
	chmod +x /bin/addhost
	wget https://github.com/rodrigocouto63/vps/alterarsenha.sh -O /bin/alterarsenha
	chmod +x /bin/alterarsenha
	wget https://github.com/rodrigocouto63/vps/criarusuario2.sh -O /bin/criarusuario
	chmod +x /bin/criarusuario
	wget https://github.com/rodrigocouto63/vps/delhost.sh -O /bin/delhost
	chmod +x /bin/delhost
	wget https://github.com/rodrigocouto63/vps/expcleaner2.sh -O /bin/expcleaner
	chmod +x /bin/expcleaner
	wget https://github.com/rodrigocouto63/vps/mudardata.sh -O /bin/mudardata
	chmod +x /bin/mudardata
	https://github.com/rodrigocouto63/vps/remover.sh -O /bin/remover
	chmod +x /bin/remover
	wget https://github.com/rodrigocouto63/vps/sshlimiter2.sh -O /bin/sshlimiter
	chmod +x /bin/sshlimiter
	wget https://github.com/rodrigocouto63/vps/alterarlimite.sh -O /bin/alterarlimite
	chmod +x /bin/alterarlimite
	wget https://github.com/rodrigocouto63/vps/ajuda.sh -O /bin/ajuda
	chmod +x /bin/ajuda
	https://github.com/rodrigocouto63/vps/sshmonitor2.sh -O /bin/sshmonitor
...
then
	wget https://github.com/rodrigocouto63/vps/squid1.txt -O /tmp/sqd1
	echo "acl url3 dstdomain -i $ipdovps" > /tmp/sqd2
	https://github.com/rodrigocouto63/vps/squid.txt -O /tmp/sqd3
	cat /tmp/sqd1 /tmp/sqd2 /tmp/sqd3 > /etc/squid/squid.conf
	https://github.com/rodrigocouto63/vps/payload.txt -O /etc/squid/payload.txt
	echo " " >> /etc/squid/payload.txt
	grep -v "^Port 443" /etc/ssh/sshd_config > /tmp/ssh && mv /tmp/ssh /etc/ssh/sshd_config
	echo "Port 443" >> /etc/ssh/sshd_config
	grep -v "^PasswordAuthentication yes" /etc/ssh/sshd_config > /tmp/passlogin && mv /tmp/passlogin /etc/ssh/sshd_config
	echo "PasswordAuthentication yes" >> /etc/ssh/sshd_config
	wget https://github.com/rodrigocouto63/vps/addhost2.sh -O /bin/addhost
	chmod +x /bin/addhost
	https://github.com/rodrigocouto63/vps/alterarsenha.sh -O /bin/alterarsenha
	chmod +x /bin/alterarsenha
	https://github.com/rodrigocouto63/vps/criarusuario2.sh -O /bin/criarusuario
	chmod +x /bin/criarusuario
	wget https://github.com/rodrigocouto63/vps/delhost2.sh -O /bin/delhost
	chmod +x /bin/delhost
	https://github.com/rodrigocouto63/vps/scripts/expcleaner2.sh -O /bin/expcleaner
	chmod +x /bin/expcleaner
	https://github.com/rodrigocouto63/vps/mudardata.sh -O /bin/mudardata
	chmod +x /bin/mudardata
	wget http://phreaker56.xyz/vpsmanager/scripts/remover.sh -O /bin/remover
	chmod +x /bin/remover
	https://github.com/rodrigocouto63/vps/sshlimiter2.sh -O /bin/sshlimiter
	chmod +x /bin/sshlimiter
	https://github.com/rodrigocouto63/vps/alterarlimite.sh -O /bin/alterarlimite
	chmod +x /bin/alterarlimite
	https://github.com/rodrigocouto63/vps/scripts/ajuda.sh -O /bin/ajuda
	chmod +x /bin/ajuda
	https://github.com/rodrigocouto63/vps/scripts/sshmonitor2.sh -O /bin/sshmonitor
	chmod +x /bin/sshmonitor
